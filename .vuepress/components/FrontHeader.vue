<template>
    <div id="front-header">
        ...
        <p>
            ...
            <a href="https://www.npmjs.com/package/@ls-lint/ls-lint"><img src="https://badgen.net/static/npm%20downloads%20total/4M+/green" alt="NPM Downloads"></a>
        ...
        <p id="get-started">
            <a id="get-started-button" href="/2.2/getting-started/introduction.html">Get Started &rarr;</a>
        </p>
    </div>
</template>
